        ...
        <form action="{{ route('search') }}" method="GET" class="w-full max-w-xl">
            <div class="flex flex-col items-center border-b border-teal-500 py-2">
                ...
                <div class="flex w-full justify-between mb-3">
                    <select name="stock" class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline text-black mr-2">
                    ...
                    <select name="type" class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline text-black">
                        ...
                        @foreach ($types as $type)
                            <option value="{{ $type->jenis_barang }}">{{ $type->jenis_barang }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <!-- Dashboard Link -->
                @if (Route::has('login'))
                    <div class="w-full text-center gap-2">
                        @auth
                            <a href="{{ url('/dashboard') }}" class="text-sm text-white bg-blue-500 hover:bg-blue-700 py-2 px-4 rounded">
                                Dashboard
                            </a>
                        @else
                            <a href="{{ route('login') }}" class="text-sm text-white bg-blue-500 hover:bg-blue-700 py-2 px-4 mr-2 rounded">
                                Log in
                            </a>
                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="text-sm text-white bg-blue-500 hover:bg-blue-700 ml-2 py-2 px-4 rounded">
                                    Register
                                </a>
                            @endif
                        @endauth
