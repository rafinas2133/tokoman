<div class="container mx-auto px-4">
    <h1 class="text-2xl font-bold my-4 dark:text-white text-black">Edit agents</h1>
    <form action="{{ route('agents.update', $agents->id) }}" method="POST" class="dark:text-white text-black" enctype="multipart/form-data">
        @csrf
        @method('put')
        <div class="mb-4">
