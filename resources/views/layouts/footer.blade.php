<footer class="footer py-4 bg-white dark:bg-gray-800 border-gray-100 dark:border-gray-700 border-t">
    <div class="mx-12 grid grid-cols-1 md:grid-cols-3 gap-4 text-black dark:text-white">
        ...
        <div class="flex flex-col items-center justify-start md:items-center space-y-2">
            <img src="https://tokoman.s3.ap-southeast-2.amazonaws.com/asset/logo.png" alt="Logo" class="mr-3 h-32">
        ...
        <div
            class="flex flex-col items-center max-md:mt-12 justify-center md:self-center md:justify-center md:text-left text-center">
            <h3 class="font-semibold">Kantor</h3>
            <p>Jl. Manukwari No. 21 Satreyan Kanigoro<br>
                Kel. Satreyan, Kec. Kanigoro<br>
                Blitar, Jawa Timur</p>
        </div>
