<x-app-layout>
 ...
 <form action="{{url('/stok/addsave')}}" method="post" class="needs-validation text-white">
    @csrf
    <div class="mb-4">
    ...
    <input type="text" id="jenis" name="jenis" required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
    </div>
