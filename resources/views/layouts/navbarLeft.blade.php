<!-- Hamburger Button -->
    ...
    <div class="bg-gray-800 text-white h-full border-r border-t border-gray-700 transform -translate-x-full sm:translate-x-0 max-[640px]:hidden transition-transform duration-300">
