...
Route::middleware(['auth', 'verified'])->middleware(['auth','admin'])->group(function () {
...
//Route Pegawai dan Admin
Route::middleware(['auth', 'verified'])->group(function () {
    Route::get('/dashboard', function () {
        return view('dashboard');
    })->name('dashboard');
    Route::get('/stok', [barangController::class,'employeeIndex'])->name('stokIndex');
